...
const HeroBannerSlider = () => {
  ...
  const heroImages = [
    { img: "/banner-pic.png", titl: "Slide 1" },
    // { img: "/hero/slide2.jpg", titl: "Slide 2" },
    // { img: "/hero/slide3.jpg", titl: "Slide 3" },
  ];

  const handleUpdate = (newIndex) => {
    if (newIndex < 0) {
      newIndex = heroImages.length - 1;
    } else if (newIndex >= heroImages.length) {
      newIndex = 0;
    }
    setCurrentIndex(newIndex);
  };
