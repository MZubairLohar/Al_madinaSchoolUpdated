          ...
          <AnimatedComponentRight>
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base sm:text-lg md:text-lg mt-4 text-gray-700 font-bold">
                ...
                respect, collaboration, and a shared commitment to Islamic
                values. We celebrate diversity and encourage students to engage
                with and contribute to the community through various events.
              </p>
            </div>
          </AnimatedComponentRight>
        </div>
