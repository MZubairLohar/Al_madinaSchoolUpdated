          ...
          <AnimatedComponentRight>
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base sm:text-lg md:text-lg mt-4 text-gray-700 font-bold">
                ...
                3:30. Our schedule includes time for academic classes, prayers,
                breaks, and extracurricular activities. Each day is structured
                to provide a balanced mix of learning, reflection, and
                recreation.
              </p>
            </div>
          </AnimatedComponentRight>
